...
const CongresoInnovacionSecretarial = () => {
  const query = useQuery();
  const titulo = query.get('titulo') || "CONGRESO DE INNOVACION SECRETARIAL Y TECNOLOGIA";
    ...
    <div>
      <section>
        <CursoPropEntrada
          ...
          imagenSrc="/img/congreso-gestion.png"
        />
      </section>
      <section>
        <CursoPropCuerpo2
      ...
      <section>
        ...
        <CursoPropSalida secciones={contenidoCongresos.congresoInnovacionSecretarial} />
      </section>
    </div>
  );
};

export default CongresoInnovacionSecretarial;
