...
function Asesoria_Consultoria() {
  return (
    <>
      ...
      <div className="cubo-grid">
        <div className='cubo-1'>
        ...
        <div className='cubo-2'>
          <span role="img" aria-label="university">🏛️</span>
        ...
        <div className='cubo-4'>
          <span role="img" aria-label="boxes">📦</span>
